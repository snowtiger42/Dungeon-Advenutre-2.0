...
class DungeonAdventure:
    ...
    def __choose_class(self, class_choice = None):
        # --Buttons
        class_value = 0
        ...
        self.__start_canvas.create_window(button_x - 260, button_y, window=st_menu_button1)
        st_menu_button1.config(command=self.__input_name)
        print(st_menu_button1)

        st_menu_button2 = tk.Button(text='Cleric', font="Verdana 10 bold", width=10)
        self.__start_canvas.create_window(button_x, button_y, window=st_menu_button2)
        st_menu_button2.config(command=self.__input_name)

        st_menu_button3 = tk.Button(text='Thief', font="Verdana 10 bold", width=10)
        self.__start_canvas.create_window(button_x + 260, button_y, window=st_menu_button3)
        st_menu_button3.config(command=self.__input_name)

        # def __determine_class(self):
        #     if st_menu_button1 is True:
        #         class_choice = "Warrior"
        #         # class_value = 1
        #         # # return class_value
        #         return class_choice
        #     elif st_menu_button2.config:
        #         class_choice = "Cleric"
        #         class_value = 2
        #         return class_choice
        #     elif st_menu_button3.config:
        #         class_choice = "Thief"
        #         class_value = 3
        #         return class_choice
        #     return
    ...
    def __input_name(self): #Around here, place the option to choose between the 3 hero classes
        """
        ...
        def __user_input_adventurer_name():
            is_warrior = self.__choose_class("Warrior")
            is_cleric = self.__choose_class("Cleric")
            is_thief = self.__choose_class("Thief")
