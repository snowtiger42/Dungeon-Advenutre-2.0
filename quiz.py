...
class Quiz:
    ...
    def insert(self, category, question, answer):
        ...
        with conn:
            ...
            sqliteinsert.create_question(conn, question)
    ...
    def update(self, id, category, question, answer):
        ...
        with conn:
            sqliteupdate.update_task(conn, (id, category, question, answer))
    ...
    def select(self, category):
        ...
        with conn:
            if category == 'Abstraction':
                ...
                self.__row = sqliteselect.selected_quiz(sqliteselect.select_quiz_by_priority(conn, q_id))
    ...
    def start_quiz(self, category):
        ...
        button1.config(command=lambda: self.quiz_answer('True', self.__answer))
        ...
        button2.config(command=lambda: self.quiz_answer('False', self.__answer))
        ...
        button3.config(command=lambda: self.quiz_answer('Dumb', self.__answer))

        self.__root.mainloop()

    def quiz_answer(self, my_ans, cor_ans):
        ...
        button.config(command=lambda: self.quiz_grade(self.grade))

    def quiz_grade(self, grade):
        if grade:
            quit()
        else:
            quit()
