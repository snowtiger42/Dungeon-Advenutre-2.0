...
from warrior import Warrior as War
from mock_game import MockGame as Game
from room import Room

class DungeonTest(unittest.TestCase):
    def test_init(self):
        my_dungeon = Dungeon(1, Game(), War("test", Game()))
    ...
    def test_generate(self):
        my_game = Game()
        war = War("Test a Warrior", my_game)
        my_dungeon = Dungeon(1, my_game, war)
        ...
        # ensure warrior is in the entrance room
    ...
    def make_toy_dungeon(self):
        ...
        return my_dungeon, entrance_room, next_room, war

    def test_movement_bad_direction_code(self):
        my_dungeon, entrance_room, next_room, war = self.make_toy_dungeon()

        self.assertRaises(ValueError, my_dungeon.move_player, war, "f")

    def test_movement_valid_move_dir(self):
        my_dungeon, entrance_room, next_room, war = self.make_toy_dungeon()

        my_dungeon.move_player(war, "n")
